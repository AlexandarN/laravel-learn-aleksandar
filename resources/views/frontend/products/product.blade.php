				...
				<div class="col-md-6">
					<div class="c-product-gallery">
						<div class="c-product-gallery-content">
							<div class="c-zoom">
								<img src="/templates/frontend/theme/assets/base/img/content/shop8/34.jpg">
							</div>
							<div class="c-zoom">
								<img src="/templates/frontend/theme/assets/base/img/content/shop8/35.jpg">
							</div>
							<div class="c-zoom">
								<img src="/templates/frontend/theme/assets/base/img/content/shop8/37.jpg">
							</div>
							<div class="c-zoom">
								<img src="/templates/frontend/theme/assets/base/img/content/shop8/29.jpg">
							</div>
						</div>
						<div class="row c-product-gallery-thumbnail">
							<div class="col-xs-3 c-product-thumb">
								<img src="/templates/frontend/theme/assets/base/img/content/shop/91.jpg">
							</div>
							<div class="col-xs-3 c-product-thumb">
								<img src="/templates/frontend/theme/assets/base/img/content/shop/92.jpg">
							</div>
							<div class="col-xs-3 c-product-thumb">
								<img src="/templates/frontend/theme/assets/base/img/content/shop/02.jpg">
							</div>
							<div class="col-xs-3 c-product-thumb c-product-thumb-last">
								<img src="/templates/frontend/theme/assets/base/img/content/shop/80.jpg">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane fade in active" id="tab-1"> 
				<div class="c-product-desc c-center">
					<div class="container">
						<img src="/templates/frontend/theme/assets/base/img/content/shop5/30.png"/>
						<p>
				...
				<div class="c-product-desc c-bg-dark">
					<div class="container">
						<div class"row">
							<div class="col-md-6">
								<img src="/templates/frontend/theme/assets/base/img/content/shop5/32.png"/>
							</div>
							<div class="col-md-6">
								<div class="c-content-title-1">
				...
				<div class="c-product-desc c-bg-grey">
					<div class="container">
						<div class"row">
							...
							<div class="col-md-6">
								<img src="/templates/frontend/theme/assets/base/img/content/shop5/31.png"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div role="tabpanel" class="tab-pane fade" id="tab-3">
				<div class="container">
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="c-user-avatar">
								<img src="/templates/frontend/theme/assets/base/img/content/avatars/team1.jpg"/>
							</div>
					...
					<div class="row c-margin-t-40">
						<div class="col-xs-6">
							<div class="c-user-avatar">
								<img src="/templates/frontend/theme/assets/base/img/content/avatars/team12.jpg"/>
							</div>
							<div class="c-product-review-name">
					...
					<div class="row c-margin-t-40">
						<div class="col-xs-6">
							<div class="c-user-avatar">
								<img src="/templates/frontend/theme/assets/base/img/content/avatars/team8.jpg"/>
							</div>
							<div class="c-product-review-name">
...
<div class="c-layout-go2top">
	...
	<!-- END: THEME SCRIPTS -->
			...
			<!-- BEGIN: PAGE SCRIPTS -->
								<script src="/templates/frontend/theme/assets/plugins/zoom-master/jquery.zoom.min.js" type="text/javascript"></script>
							<!-- END: PAGE SCRIPTS -->
