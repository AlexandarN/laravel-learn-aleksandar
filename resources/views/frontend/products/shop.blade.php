...
<head>
	<meta charset="utf-8"/>
	<title>JANGO | Ultimate Multipurpose Bootstrap HTML Theme - Shop Home 8</title>
	...
	<link href="/templates/frontend/theme/assets/plugins/socicon/socicon.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/plugins/bootstrap-social/bootstrap-social.css" rel="stylesheet" type="text/css"/>		
	<link href="/templates/frontend/theme/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/plugins/animate/animate.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	<!-- END GLOBAL MANDATORY STYLES -->

			<!-- BEGIN: BASE PLUGINS  -->
			<link href="/templates/frontend/theme/assets/plugins/revo-slider/css/settings.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/revo-slider/css/layers.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/revo-slider/css/navigation.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/cubeportfolio/css/cubeportfolio.min.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/fancybox/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/theme/assets/plugins/slider-for-bootstrap/css/slider.css" rel="stylesheet" type="text/css"/>
				<!-- END: BASE PLUGINS -->
	
	
    <!-- BEGIN THEME STYLES -->
	<link href="/templates/frontend/theme/assets/demos/default/css/plugins.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/demos/default/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/theme/assets/demos/default/css/themes/default.css" rel="stylesheet" id="style_theme" type="text/css"/>
	<link href="/templates/frontend/theme/assets/demos/default/css/custom.css" rel="stylesheet" type="text/css"/>
	<!-- END THEME STYLES -->
		...
		<div class="container">
			...
			<div class="c-brand">
				<a href="index.html" class="c-logo">
					<img src="/templates/frontend/theme/assets/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-desktop-logo">
					<img src="/templates/frontend/theme/assets/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-desktop-logo-inverse">
					<img src="/templates/frontend/theme/assets/base/img/layout/logos/logo-3.png" alt="JANGO" class="c-mobile-logo">
				</a>	
	                ...
	                <div class="col-md-5 c-mega-menu-offers-desktop">
               			<ul class="c-mega-menu-offers-img-set">
               				<li class="c-mega-menu-offers-img">
           						<a href="#"><img src="/templates/frontend/theme/assets/base/img/content/shop/12.jpg" class="c-offers-img-1"/></a>
               				...
               				<li class="c-mega-menu-offers-img">
           						<a href="#"><img src="/templates/frontend/theme/assets/base/img/content/shop/44.jpg" class="c-offers-img-2"/></a>
           						<div class="c-mega-menu-offers-overlay">
	        ...
	        <ul class="dropdown-menu c-menu-type-mega c-menu-type-fullwidth" style="min-width: auto">
	            <li class="c-mega-menu-collections-col c-mega-menu-offers-desktop">
	                <ul class="dropdown-menu c-menu-type-inline c-mega-menu-offers-img-set">
	                    ...
	                    <li class="c-mega-menu-offers-img">
	                       	<img src="/templates/frontend/theme/assets/base/img/content/shop2/13.jpg" class="c-offers-img-1"/>
       						<div class="c-mega-menu-offers-overlay">
	            ...
	            <li class="c-mega-menu-collections-col c-mega-menu-offers-desktop">
	                <ul class="dropdown-menu c-menu-type-inline c-mega-menu-offers-img-set">
	                    ...
	                    <li class="c-mega-menu-offers-img">
	                        <img src="/templates/frontend/theme/assets/base/img/content/shop2/31.jpg" class="c-offers-img-1"/>
       						<div class="c-mega-menu-offers-overlay">
	            ...
	            <li class="c-mega-menu-collections-col c-mega-menu-offers-desktop">
	                <ul class="dropdown-menu c-menu-type-inline c-mega-menu-offers-img-set">
	                    ...
	                    <li class="c-mega-menu-offers-img">
	                        <img src="/templates/frontend/theme/assets/base/img/content/shop2/12.jpg" class="c-offers-img-1"/>
       						<div class="c-mega-menu-offers-overlay">
	            ...
	            <li class="c-mega-menu-collections-col c-mega-menu-offers-desktop">
	                <ul class="dropdown-menu c-menu-type-inline c-mega-menu-offers-img-set">
	                    ...
	                    <li class="c-mega-menu-offers-img c-mega-menu-offers-desktop">
	                        <img src="/templates/frontend/theme/assets/base/img/content/shop2/51.jpg" class="c-offers-img-1"/>
       						<div class="c-mega-menu-offers-overlay">
	            ...
	            <li class="c-mega-menu-collections-col c-mega-menu-offers-desktop">
	                <ul class="dropdown-menu c-menu-type-inline c-mega-menu-offers-img-set">
	                    ...
	                    <li class="c-mega-menu-offers-img">
	                        <img src="/templates/frontend/theme/assets/base/img/content/shop2/79.jpg" class="c-offers-img-1"/>
       						<div class="c-mega-menu-offers-overlay">
...
<div class="c-cart-menu">
	...
	<ul class="c-cart-menu-items">
		<li>
			...
			<img src="/templates/frontend/theme/assets/base/img/content/shop2/24.jpg"/>
		...
		<li>
			...
			<img src="/templates/frontend/theme/assets/base/img/content/shop2/12.jpg"/>
			<div class="c-cart-menu-content">
				<p>1 x <span class="c-item-price c-theme-font">$30</span></p>
...
<nav class="c-layout-quick-sidebar">
					...
					<div class="col-md-12">
						<a href="../default/index.html" class="c-demo-container c-demo-img-lg">
							<div class="c-demo-thumb active">
								<img src="/templates/frontend/theme/assets/base/img/content/quick-sidebar/default.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>	
					</div>
				</div>
					...
					<div class="col-md-6">
						<a href="../corporate_1/index.html" class="c-demo-container">
							<div class="c-demo-thumb  c-thumb-left">
								<img src="/templates/frontend/theme/assets/base/img/content/quick-sidebar/corporate_1.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>	
					</div>
					<div class="col-md-6">
						<a href="../agency_1/index.html" class="c-demo-container">
							<div class="c-demo-thumb  c-thumb-right">
								<img src="/templates/frontend/theme/assets/base/img/content/quick-sidebar/corporate_1-onepage.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>	
					</div>
				</div>			
	...
	<div class="c-layout-page">
		<!-- BEGIN: PAGE CONTENT -->
		<!-- BEGIN: LAYOUT/SLIDERS/SHOP-REVO-SLIDER-5 -->
            ...
            <ul>
                ...
                <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="/templates/frontend/theme/assets/base/img/content/shop4/34.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Let's go JANGO" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3 c-font-white c-font-bold" 
                        ...
                        style="z-index: 5; white-space: nowrap;">LET'S GO SHOPPING
                    </div>

                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3 c-font-white" 
                         id="slide-16-layer-4" 
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        ...
                        style="z-index: 6; white-space: nowrap;">CRAZY DEALS AT LOWEST PRICES
                    </div>

                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption NotGeneric-Icon   tp-resizeme rs-parallaxlevel-3" 
                         id="slide-16-layer-8" 
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3" 
                        ...
                        <a href="https://themeforest.net/item/jango-highly-flexible-component-based-html5-template/11987314?_ga=1.134549810.2110892575.1481634713" class="c-action-btn btn btn-lg c-btn-square c-theme-btn c-btn-bold c-btn-uppercase">BROWSE NOW</a>
                    </div>
                </li>
                <!--END -->  
                <!-- BEGIN: SLIDE #2 -->
                <li data-index="rs-17" data-transition="fadetotopfadefrombottom" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"  data-thumb="/templates/frontend/theme/assets/base/img/content/shop4/104.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Parallax" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="/templates/frontend/theme/assets/base/img/content/shop4/104.jpg"  alt="" data-bgposition="center bottom" data-kenburns="on" data-duration="15000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="-500 500" data-offsetend="500 -500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3 c-font-white c-font-bold" 
                        ...
                        style="z-index: 5; white-space: nowrap;">SUMMER COLLECTION
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-2 c-font-white" 
                        ...
                        style="z-index: 6; white-space: nowrap;">GET YOUR TAN ON
                    </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3" 
                         id="slide-20-layer-8" 
                ...
                <!-- END -->
                <!-- SLIDE #3  -->
                <li data-index="rs-20" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="/templates/frontend/theme/assets/base/img/content/shop4/57.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Love it?" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="/templates/frontend/theme/assets/base/img/content/shop4/57.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="15000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3 c-font-white c-font-bold" 
                        ...
                        style="z-index: 5; white-space: nowrap;">WINTER COLLECTION
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3 c-font-white" 
                        ...
                        style="z-index: 6; white-space: nowrap;">WRAP UP WITH FASHION
                    </div>
...
</section><!-- END: LAYOUT/SLIDERS/SHOP-REVO-SLIDER-5 -->

<!-- BEGIN: CONTENT/SHOPS/SHOP-5-3 -->
<div class="c-content-box c-overflow-hide c-size-md c-bs-grid-reset-space">
	<div class="container">
		<div class="c-content-title-1">
			<h3 class="c-center c-font-uppercase c-font-bold">What's New</h3>
			<div class="c-line-center c-theme-bg"></div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="c-content-product-5">
					<div class="c-bg-img-center" style="height:800px;background-image: url(../../assets/base/img/content/shop/09.jpg)">
						<div class="c-detail c-bg-dark c-bg-opacity-2">
							...
							<h3 class="c-title c-font-uppercase c-font-bold c-font-white c-font-90">SUMMER TIME</h3>
							...
							<div class="c-overlay-wrapper">
								<div class="c-overlay-content">
									<h3 class="c-title c-margin-tb-30 c-font-uppercase c-font-bold c-font-30 c-font-white c-padding-20">
										<span class="c-font-thin">Accessories</span><br/>Collection
									</h3>
									<a href="shop-product-details-2.html" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">Shop Now</a>
								</div>
							</div>
							<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 400px; background-image: url(../../assets/base/img/content/shop3/97.jpg);"></div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="c-content-product-5">
							<div class="c-bg-img-center c-center" style="height:400px;background-image: url(../../assets/base/img/content/shop3/14.jpg)">
								<div class="c-wrapper c-center-vertical">
									<h3 class="c-title c-margin-tb-30 c-font-30 c-font-uppercase c-font-bold c-font-white">
										<span class="c-line"><span class="c-font-thin">Latest</span> Collection</span>
									</h3>
...
</div><!-- END: CONTENT/SHOPS/SHOP-5-3 -->
		...
		<div class="row">
			<div class="col-md-7 col-sm-6">
				<div class="c-content c-content-overlay">
					...
					<div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 550px; background-image: url(../../assets/base/img/content/shop7/05.png);"></div>
			...
			<div class="col-md-5 col-sm-6">
				<div class="c-content c-content-overlay">
					...
					<div class="c-bg-img-top-center c-overlay-object" data-height="height" style="height: 550px; background-image: url(../../assets/base/img/content/shop7/02.png);"></div>
					<div class="c-overlay-border"></div>
				</div>
			</div>
		</div>
		...
		<div class="c-prefooter">
			...
			<div class="c-foot">
				<div class="row">
					<div class="col-md-7">
						<div class="c-content-title-1 c-title-md">
							<h3 class="c-title c-font-uppercase c-font-bold">About JAN<span class="c-theme-font">GO</span></h3>
							<div class="c-line-left hide"></div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-12 c-col">
					...
					<ul class="list-unstyled list-inline pull-right">
						<li><img class="img-responsive" src="/templates/frontend/theme/assets/base/img/content/payments/light/1.png" width="60" /></li>
						<li><img class="img-responsive" src="/templates/frontend/theme/assets/base/img/content/payments/light/2.png" width="60" /></li>
						<li><img class="img-responsive" src="/templates/frontend/theme/assets/base/img/content/payments/light/22.png" width="60" /></li>
						<li><img class="img-responsive" src="/templates/frontend/theme/assets/base/img/content/payments/light/5.png" width="60" /></li>
						<li><img class="img-responsive" src="/templates/frontend/theme/assets/base/img/content/payments/light/6.png" width="60" /></li>
					</ul>
				</div>
							</div>
		</div>
...
<div class="c-layout-go2top">
    ...
    <!-- BEGIN: CORE PLUGINS -->
	<!--[if lt IE 9]>
	<script src="/templates/frontend/theme/assets/global/plugins/excanvas.min.js"></script> 
	<![endif]-->
	<script src="/templates/frontend/theme/assets/plugins/jquery.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/theme/assets/plugins/jquery-migrate.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/theme/assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/theme/assets/plugins/jquery.easing.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/theme/assets/plugins/reveal-animate/wow.js" type="text/javascript" ></script>
	<script src="/templates/frontend/theme/assets/demos/default/js/scripts/reveal-animate/reveal-animate.js" type="text/javascript" ></script>

	<!-- END: CORE PLUGINS -->

			<!-- BEGIN: LAYOUT PLUGINS -->
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.slideanims.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.layeranimation.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.navigation.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.video.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.parallax.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/smooth-scroll/jquery.smooth-scroll.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/typed/typed.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/slider-for-bootstrap/js/bootstrap-slider.js" type="text/javascript"></script>
			<script src="/templates/frontend/theme/assets/plugins/js-cookie/js.cookie.js" type="text/javascript"></script>
				<!-- END: LAYOUT PLUGINS -->
	
	<!-- BEGIN: THEME SCRIPTS -->
	<script src="/templates/frontend/theme/assets/base/js/components.js" type="text/javascript"></script>
	<script src="/templates/frontend/theme/assets/base/js/components-shop.js" type="text/javascript"></script>
	<script src="/templates/frontend/theme/assets/base/js/app.js" type="text/javascript"></script>
	<script>
	...
	<!-- END: THEME SCRIPTS -->
			...
			<!-- BEGIN: PAGE SCRIPTS -->
								<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.kenburn.min.js" type="text/javascript"></script>
											<script src="/templates/frontend/theme/assets/plugins/revo-slider/js/extensions/revolution.extension.parallax.min.js" type="text/javascript"></script>
											<script src="/templates/frontend/theme/assets/demos/default/js/scripts/revo-slider/shop-slider-5.js" type="text/javascript"></script>
							<!-- END: PAGE SCRIPTS -->
